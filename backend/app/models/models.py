...
class Match(Base):
    ...
    side_a_registration_id = Column(BigInteger, ForeignKey("registrations.id"), index=True, nullable=False)
    side_b_registration_id = Column(BigInteger, ForeignKey("registrations.id"), index=True, nullable=False)
    winner_side = Column(String(5))
