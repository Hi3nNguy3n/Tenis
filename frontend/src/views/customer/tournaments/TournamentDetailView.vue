...
.status-badge { display: inline-block; padding: 0.5rem 1rem; border-radius: 8px; font-weight: 500; font-size: 0.75rem; letter-spacing: 0.1em; margin-bottom: 1.5rem; background: rgba(255, 255, 255, 0.2); }
...
:deep(.el-tabs__item) { font-size: 1.1rem; font-weight: 500; height: 50px; line-height: 50px; }
...
.info-card .value { font-size: 1.2rem; font-weight: 500; color: var(--text-dark); }
...
.price-value { font-size: 1.5rem; font-weight: 500; color: var(--primary); }
...
.slot-count { font-size: 1.4rem; font-weight: 500; color: var(--text-dark); }
...
.btn-register { width: 100%; padding: 1.2rem; border-radius: 8px; border: none; background: linear-gradient(135deg, var(--primary) 0%, var(--primary-hover) 100%); color: white; font-weight: 500; font-size: 1.1rem; cursor: pointer; transition: transform 0.2s; }
.btn-register:hover { transform: scale(1.02); }
.btn-disabled { width: 100%; padding: 1.2rem; border-radius: 8px; border: none; background: #e0e0e0; color: #9e9e9e; font-weight: 500; cursor: not-allowed; }
